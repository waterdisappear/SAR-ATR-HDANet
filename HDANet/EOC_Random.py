...
from HDANet.utils.TrainTest import model_train, model_test_eoc4R
...
if __name__ == '__main__':
    ...
    for k in tqdm(range(arg.fold)):
        ...
        acc_9 = model_test_eoc4R(model, test_loader, SNR=0.95)
        acc_8 = model_test_eoc4R(model, test_loader, SNR=0.90)
        acc_7 = model_test_eoc4R(model, test_loader, SNR=0.85)
        acc_6 = model_test_eoc4R(model, test_loader, SNR=0.80)
        acc_5 = model_test_eoc4R(model, test_loader, SNR=0.75)
